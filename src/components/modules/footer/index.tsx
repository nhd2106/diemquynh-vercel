      ...
      <div className="md:max-w-7xl mx-auto py-12 px-4 sm:px-2 md:py-16 md:px-8">
              ...
              <div>
                ...
                <ul className="mt-4 space-y-4 text-white">
                  <li className="flex space-x-2">
                    ...
                    <span>
                      44 Tay Son St, Tan Quy ward, Tan Phu Dist, HCMC, Vietnam.
                    </span>
                  </li>
                  <li className="flex space-x-2">
                  ...
                  <li className="flex space-x-2 items-center">
                    <Mail className="h-5 w-5 md:w-10 md:h-10" />
                    <span>myngo@vanthinhseafoods.com</span>
                  </li>
                </ul>
              </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
            &copy; 2022 VanThinhSeafoods, Inc. All rights reserved.
          </p>
        </div>

        <Link
          href="https://www.duoc95.com/"
          rel="noreferrer"
          target="_blank"
