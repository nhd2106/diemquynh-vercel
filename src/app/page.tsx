  ...
  return (
    <div className="text-white">
      <div
        ...
        className="pt-96 pb-36 relative"
      >
        ...
        <div className="relative z-10 text-white">
          <div className=" flex justify-center flex-col items-center text-center">
            ...
            <p data-aos="fade-left" className="w-3/4 md:w-2/5 text-center">
              Welcome to Van Thinh Seafoods! We specialize in exporting
              top-quality seafood, including Barramundi, Grouper, Red Snapper,
              Red Spot Emperor, King Snapper, Goldband Snapper, Crimson Snapper,
              Mahi Mahi, and Parrotfish. Our products are sourced from pristine
              waters, ensuring freshness and premium taste. Whether you&apos;re
              a seafood lover, chef, or consumer, we offer a diverse range of
